...
let lunes= new Horarios    ("Lunes", "08hs a 12hs", "Dr. Lautaro Gimenez", "Clinico", "Prepaga: SI", "https://img.freepik.com/foto-gratis/doctor-brazos-cruzados-sobre-fondo-blanco_1368-5790.jpg?w=2000");
let lunes2= new Horarios   ("Lunes", "16hs a 20hs", "Dr. Lautaro Gimenez", "Clinico", "Prepaga: SI", "https://img.freepik.com/foto-gratis/doctor-brazos-cruzados-sobre-fondo-blanco_1368-5790.jpg?w=2000");
let martes= new Horarios   ("Martes", "08hs a 12hs", "Lic. Agustín Palacios", "Nutricionista", "Prepaga: NO", "https://bosworthinstitute.com/wp-content/uploads/2020/07/Nutricionista-bosworth-carrera.png");
let martes2= new Horarios  ("Martes", "16hs a 20hs", "Lic. Maria Cordoba", "Nutricionista", "Prepaga: NO", "https://nutricionistahuelva.es/ficheros/servicios/psiconutricion_C_4.jpg");
let mier= new Horarios     ("Miercoles", "08hs a 12hs", "Dra. Rocio Matozo", "Pediatra", "Prepaga: SI", "https://ximenamargain.com/wp-content/uploads/2021/07/DOCTORA-XIMENA-LINKS-PEDIATRA.jpg");
let mier2= new Horarios    ("Miercoles", "16hs a 20hs", "Dr. Lautaro Gimenez", "Clinico", "Prepaga: SI", "https://img.freepik.com/foto-gratis/doctor-brazos-cruzados-sobre-fondo-blanco_1368-5790.jpg?w=2000");
let juev= new Horarios     ("Jueves", "08hs a 16hs", "Dra. Rocio Matozo", "Pediatra", "Prepaga: SI", "https://ximenamargain.com/wp-content/uploads/2021/07/DOCTORA-XIMENA-LINKS-PEDIATRA.jpg");
let juev2= new Horarios    ("Jueves", "16hs a 20hs", "Dr. Lautaro Gimenez", "Clinico", "Prepaga: SI", "https://img.freepik.com/foto-gratis/doctor-brazos-cruzados-sobre-fondo-blanco_1368-5790.jpg?w=2000");
let vier= new Horarios     ("Viernes", "08hs a 12hs", "Dr. Gregorio Muñoz", "Cardiologia", "Prepaga: NO", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSC8a-31MUy64qk80BIpp8cpv8q273vQFMIkXBdWmnNU96bXD1fKfG5vYW82Nf-kRMq1VM&usqp=CAU");
let vier2= new Horarios    ("Viernes", "16hs a 20hs", "Dr. Lautaro Gimenez", "Clinico", "Prepaga: SI", "https://img.freepik.com/foto-gratis/doctor-brazos-cruzados-sobre-fondo-blanco_1368-5790.jpg?w=2000");
